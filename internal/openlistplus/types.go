...
type Addition struct {
	...
	AutoRestoreExistingCASPaths string `json:"auto_restore_existing_cas_paths" type:"text" help:"Monitored directories for automatic .cas restore, one path per line; leave empty to disable monitoring"`
}
...
type Bridge interface {
	...
	OpenListPlusDeletePermanently(ctx context.Context, obj model.Obj) error
